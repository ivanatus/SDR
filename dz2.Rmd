...
Potrebno je razviti programsku podršku za generiranje CDMA kompozitnog signal s 4 paralelna komunikacijska signala s kodnim sekvencama od 5 bitova.
...
Nakon definicije pomoćnih funkcija (ascii_to_binary, encode_message, decode_message), definirane su kodne sekvence za svaki od 4 kanala (po primjeru s predavanja) te je zapisana funkcija koja služi za generiranje signala.
...
Potom definiramo poruke, generiramo signal te ispišemo dobivene rezultate.
