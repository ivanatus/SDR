...
## Definicija funkcije Klobucharovog modela

Sljedeći kod prikazuje zapis algoritma Klobucharovog modela definiranog koracima u vježbi 19,20 iz kolegija Programski određen radio. S obzirom da su parametri (kutovi) zadani u stupnjevima, unutar prvog dijela funkcije se iz stupnjeva pretvaraju u radijane kako bi se daljnje operacije mogle izvoditi.
...
## Definicija parametara za primjer modela

U sljedećem kodu su zapisani parametri kojim se definirao numerički primjer.
